...
--#profile     RemoteProfiler.zoneEnd()
    ...
    local maxNumVehicleUpdatesPerFrame = 1
    ...
    local distanceToCamera = MathUtil.vector3Length(x-cx, y-cy, cz-z)
    if distanceToCamera < 150 then
        maxNumVehicleUpdatesPerFrame = math.huge
    elseif distanceToCamera < 300 then
        maxNumVehicleUpdatesPerFrame = 3
    end
