...
function Rideable:onUpdateInterpolation(dt, isActiveForInput, isActiveForInputIgnoreSelection, isSelected)
    ...
    if spec.isOnGround and (math.abs(spec.currentSpeed) > 0.001 or math.abs(spec.currentTurnSpeed) > 0.001) then
        ...
        raycastClosest(fx, fy + Rideable.GROUND_RAYCAST_OFFSET, fz, 0.0, -1.0, 0.0, Rideable.GROUND_RAYCAST_MAXDISTANCE, "groundRaycastCallback", self, Rideable.GROUND_RAYCAST_COLLISIONMASK)
        ...
        raycastClosest(bx, by + Rideable.GROUND_RAYCAST_OFFSET, bz, 0.0, -1.0, 0.0, Rideable.GROUND_RAYCAST_MAXDISTANCE, "groundRaycastCallback", self, Rideable.GROUND_RAYCAST_COLLISIONMASK)
        ...
        raycastClosest(posX, posY, posZ, 0.0, -1.0, 0.0, Rideable.GROUND_RAYCAST_MAXDISTANCE, "groundRaycastCallback", self, Rideable.GROUND_RAYCAST_COLLISIONMASK)
