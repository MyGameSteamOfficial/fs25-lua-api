...
function Foldable.registerFunctions(vehicleType)
    ...
    SpecializationUtil.registerFunction(vehicleType, "setIsFoldAllowed",                Foldable.setIsFoldAllowed)
...
function Foldable:getIsFoldAllowed(direction, onAiTurnOn)
    if not self.spec_foldable.isFoldAllowed then
        return false
    end
...
function Foldable.updateActionEventFold(self)
    ...
    if actionEvent ~= nil then
        ...
        g_inputBinding:setActionEventActive(actionEvent.actionEventId, self:getIsFoldAllowed())
    end
end
