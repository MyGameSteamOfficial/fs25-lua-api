...
function PowerTakeOffs:loadOutputPowerTakeOff(xmlFile, baseName, powerTakeOffOutput)
    ...
    if next(attacherJointIndices) == nil then
        Logging.xmlWarning(xmlFile, "Pto output needs to have valid 'attacherJointIndices' or 'attacherJointNodes' in '%s'", baseName)
        return false
    end
...
function PowerTakeOffs:loadInputPowerTakeOff(xmlFile, baseName, powerTakeOffInput)
    ...
    powerTakeOffInput.material = xmlFile:getValue(baseName .. "#materialTemplateName")
    powerTakeOffInput.decalMaterial = xmlFile:getValue(baseName .. "#decalMaterialTemplateName")
...
function PowerTakeOffs:loadLocalPowerTakeOff(xmlFile, baseName, powerTakeOffLocal)
    ...
    powerTakeOffLocal.material = xmlFile:getValue(baseName .. "#materialTemplateName")
    powerTakeOffLocal.decalMaterial = xmlFile:getValue(baseName .. "#decalMaterialTemplateName")
