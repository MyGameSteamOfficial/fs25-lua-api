...
function AttacherJointTopArm.loadFromVehicleXML(vehicle, key)
    ...
    if topArm ~= nil then
        ...
        topArm.material = vehicle.xmlFile:getValue(key .. "#materialTemplateName")
        topArm.material2 = vehicle.xmlFile:getValue(key .. "#materialTemplateName2")
        topArm.decalMaterial = vehicle.xmlFile:getValue(key .. "#decalMaterialTemplateName")
